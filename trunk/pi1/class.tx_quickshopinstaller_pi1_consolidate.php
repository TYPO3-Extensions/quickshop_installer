...
<T3FlexForms>
    <data>
        ...
        <sheet index="paths">
            <language index="lDEF">
                <field index="terms">
                    <value index="vDEF">typo3conf/ext/quick_shop/files/pdf/default/typo3-quick-shop-agb_A4.pdf</value>
                </field>
                <field index="invoice">
                    <value index="vDEF">typo3conf/ext/quick_shop/files/pdf/default/typo3-quick-shop-rechnung_A4.pdf</value>
                </field>
                <field index="deliveryorder">
                    <value index="vDEF">typo3conf/ext/quick_shop/files/pdf/default/typo3-quick-shop-lieferschein_A4.pdf</value>
                </field>
            </language>
        </sheet>
    </data>
