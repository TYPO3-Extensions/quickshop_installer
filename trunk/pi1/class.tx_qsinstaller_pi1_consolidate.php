 ...
 *
 *
 *   65: class tx_qsinstaller_pi1_consolidate
 *
 *              SECTION: Main
 ...
 * @since 3.0.0
 */
class tx_qsinstaller_pi1_consolidate
{
  public $prefixId      = 'tx_qsinstaller_pi1_consolidate';                // Same as class name
  public $scriptRelPath = 'pi1/class.tx_qsinstaller_pi1_consolidate.php';  // Path to this script relative to the extension dir.
...
if (defined('TYPO3_MODE') && $TYPO3_CONF_VARS[TYPO3_MODE]['XCLASS']['ext/quickshop_installer/pi1/class.tx_qsinstaller_pi1_consolidate.php'])
{
  include_once($TYPO3_CONF_VARS[TYPO3_MODE]['XCLASS']['ext/quickshop_installer/pi1/class.tx_qsinstaller_pi1_consolidate.php']);
}